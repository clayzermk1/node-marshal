...
Marshal = (function () {
  ...
  Marshal.prototype._parseInteger = function () {
    ...
    if (small === 0) {
      ...
      var large = new Buffer(this.buffer.toString('hex', this._index, this._index + 3) + '00', 'hex').readUInt32LE();
      this._index += 3;
      return large;
    }
    else if (small === 4) {
      ...
      var large = new Buffer(this.buffer.toString('hex', this._index, this._index + 3) + 'FF', 'hex').readInt32LE();
      this._index += 3;
      return large;
    }
    else if (small === -4) {
